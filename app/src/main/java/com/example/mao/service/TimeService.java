...
public class TimeService extends Service {
    ...
    private void createToucher() {
        ...
        img_xfc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                ToastSelf.ToastSelf("现在还有"+New_SharePre.getData("time", Config.time)+"秒", New_Application.getContext());
            }
        });
